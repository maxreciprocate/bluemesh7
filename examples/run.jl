...
function run()
    ...
    PDR, worstPDR, delay, centrality = round.(collect(stats); digits=2)
    println("Packet delivery rate: $PDR, Worst delivery rate: $worstPDR, Average delay: $(delay)ms, Centrality: $centrality")
end
